...
def translate_with_gemini(text, target_lang="fa"):
    ...
    f"3.به جای عنوان و زیر عنوان ها از عنوان های جذاب و کلیدی مرتبط با متن یا پاراگراف مربوطه استفاده کن که نباید بیش تر از یک خط بشود.\n"
    f"4.ابتدا در اولین خط متن پست(یعنی بعد از عنوان اصلی) دو خط خلاصه مفید و کلیدی از کل متن بزار با زیر عنوان 'خلاصه :'.\n"
