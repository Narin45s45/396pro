...
def translate_with_gemini(text, target_lang="fa"):
    ...
    f"2. بلافاصله بعد از تگ <h1> (عنوان اصلی محتوا)، و بدون افزودن هیچ تگ یا محتوای اضافی قبل از آن، یک خلاصه مفید و کلیدی در دو خط قرار بده این خلاصه باید دقیقاً قبل از محتوای اصلی متن (مثلاً کپشن عکس، پاراگراف‌ها یا زیرعنوان‌های بعدی) قرار بگیره و هیچ تگ یا متنی بین <h1> و این خلاصه اضافه نشه.\n"
