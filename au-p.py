...
def translate_with_gemini(text, target_lang="fa"):
    ...
    f"**دستورالعمل بسیار مهم: پاسخ شما باید با یک خلاصه دو خطی از کل محتوای ورودی شروع شود.باید بولد نوشته شود. این دو خط خلاصه باید اولین و ابتدایی‌ترین بخش از پاسخ شما باشند.از توضیحات اضافه مثل 'این تحلیل در مورد فلان چیز است'خوداری کن . بعد از این خلاصه، بقیه متن را طبق قوانین زیر بازنویسی کن.**\n"
    f"قوانین مهم:\n"
...
# ... (بخش اولیه پرامپت شامل دستورالعمل خلاصه و قوانین مهم ۱ تا ۱۲ باقی می‌ماند) ...
    ...
    f"    - **جایگزینی خلاقانه عناوین و زیرعنوان‌ها:** اگر متن اصلی دارای زیرعنوان (تگ‌های H2, H3 و غیره) است، آن‌ها را صرفاً ترجمه نکن. بلکه آن‌ها را به شکلی خلاقانه، پرسش‌گرانه یا مبتنی بر فایده برای خواننده جایگزین کن که کنجکاوی او را برانگیزد، مسیر مطالعه را برایش جذاب‌تر کند و به درک بهتر هر بخش کمک نماید. برای مثال، به جای 'بررسی قیمت بیت‌کوین'، می‌توانید از 'بیت‌کوین در دوراهی حساس: مقصد بعدی قیمت کجاست؟' استفاده کنید.\n"   
