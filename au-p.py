...
def translate_with_gemini(text, target_lang="fa"):
    ...
    f"**دستورالعمل بسیار مهم: پاسخ شما باید با یک خلاصه دو خطی از کل محتوای ورودی شروع شود.باید جلوی 'خلاصه:' نوشته بشود. این دو خط خلاصه باید اولین و ابتدایی‌ترین بخش از پاسخ شما باشند.از توضیحات اضافه مثل 'این تحلیل در مورد فلان چیز است'خوداری کن . بعد از این خلاصه، بقیه متن را طبق قوانین زیر بازنویسی کن.**\n"
    f"قوانین مهم:\n"
