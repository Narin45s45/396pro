...
def translate_with_gemini(text, target_lang="fa"):
    ...
    f"20. به جای عنوان و زیر عنوان ها از عنوان های جذاب و کلیدی مرتبط به متن یا پاراگراف مربوطه استفاده کن که نباید بیش تر از یک خط بشود.\n"
    ...
    f"9. در انتها و در پاراگراف جداگانه کاربران رو تحریک به نظرسنجی کن که باید در خطی جداگانه نوشته شود و به خط قبلیش نچسبیده باشد و در تگ  p  باشد.\n"
    ...
    f"19. به جای عنوان و زیر عنوان ها از عنوان های جذاب و کلیدی مرتبط به متن یا پاراگراف مربوطه استفاده کن که نباید بیش تر از یک خط بشود.\n"
