...
def translate_with_gemini(text, target_lang="fa"):
    ...
    f"2. بلافاصله بعد از تگ <h1> (عنوان اصلی)، یک خلاصه مفید و کلیدی در دو خط با زیرعنوان 'خلاصه:' قرار بده این خلاصه باید دقیقاً قبل از محتوای اصلی متن و نه در جای دیگر باشد.\n"
