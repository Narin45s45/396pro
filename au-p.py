...
def translate_with_gemini(text, target_lang="fa"):
    ...
    f"4.در ابتدای پست دو خط خلاصه مفید و کلیدی از کل متن (نه عنوان) بزار و اولش بنویس 'خلاصه:'و عنوان مقاله رو دستکاری نکن و فقط متن مقاله رو تو دو خط خلاصه کن و بزار اول مقاله همین.\n"
