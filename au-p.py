...
f"    1. **در همه جا اصول سئو کامل رعایت بشه**.\n"
        f"   - متن رو با تگ‌های HTML مناسب (H1 برای عنوان، H2 و H3 برای زیرتیترها، p برای پاراگراف‌ها) ساختاربندی کن، اما تگ‌های اضافی (مثل div یا style) اضافه نکن.\n"
f"    2.به جای عنوان و زیر عنوان ها از عنوان های جذاب و کلیدی استفاده کن که نباید بیش تر از یک خط بشود.\n"
f"    3.ابتدا دو خط خلاصه مفید از کل متن در ابتدای متن اضافه کن  با زیر عنوان 'خلاصه :'.\n"
