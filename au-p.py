...
f"    1. در همه جا اصول سئو کامل رعایت بشه.\n"
  f"  2.متن رو با تگ‌های HTML مناسب (H1 برای عنوان، H2 و H3 برای زیرتیترها، p برای پاراگراف‌ها) ساختاربندی کن، اما تگ‌های اضافی (مثل div یا style) اضافه نکن.\n"
f"    3.به جای عنوان و زیر عنوان ها از عنوان های جذاب و کلیدی مرتبط به متن یا پاراگراف مربوطه استفاده کن که نباید بیش تر از یک خط بشود.\n"
f"    4.ابتدا در اولین خط متن پست(بعد از عنوان اصلی) دو خط خلاصه مفید و کلیدی از کل متن بزار با زیر عنوان 'خلاصه :'.\n"
f"    5.تحلیل عمیق و ارزش افزوده به متن اضافه کن.\n"
