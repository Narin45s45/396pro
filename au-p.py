...
def translate_with_gemini(text, target_lang="fa"):
    ...
    prompt = (
        f"متن زیر را به اسپانیایی روان و ساده بازنویسی کن تا برای خوانندگان عمومی قابل فهم باشد.\n"
        f"قوانین مهم:\n"
        ...
        f"۲. فقط محتوای متنی داخل تگ‌های HTML (مثل متن داخل <p>، <a>، یا <blockquote>) رو به روسی روان و ساده بازنویسی کن تا برای خوانندگان عمومی قابل فهم باشد، اما خود تگ‌ها و ساختار HTML رو تغییر نده. حتی اگه تگ‌ها ویژگی lang='en' داشته باشن، باز هم محتوای متنی داخلشون رو به ژاپنی روان و ساده بازنویسی کن تا برای خوانندگان عمومی قابل فهم باشد.\n"
