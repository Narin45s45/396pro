...
def translate_with_gemini(text, target_lang="fa"):
    ...
    f"4. بلافاصله بعد از تگ <h1> (عنوان اصلی محتوا) و قبل از محتوای اصلی متن (مثلاً کپشن عکس، پاراگراف‌ها یا زیرعنوان‌های بعدی)، یک خلاصه مفید و کلیدی در دو خط قرار بده: اولین تگ بعد از <h1> باید یه تگ <h2> با متن 'خلاصه:' باشه و بعدش یه تگ <p> برای متن خلاصه بیاد. هیچ تگ یا محتوای اضافی (مثلاً زیرعنوان یا پاراگراف دیگه) قبل از این خلاصه اضافه نکن. این خلاصه نباید تو عنوان اصلی (<h1>) یا هر جای دیگه تکرار بشه. مثال: <h1>عنوان</h1><h2>خلاصه:</h2><p>متن خلاصه...</p>.\n"
