...
def translate_with_gemini(text, target_lang="fa"):
    ...
    f"4. بلافاصله بعد از تگ <h1> (عنوان اصلی محتوا) و قبل از محتوای اصلی متن (مثلاً کپشن عکس، پاراگراف‌ها یا زیرعنوان‌های بعدی)، یک خلاصه مفید و کلیدی در دو خط قرار بده: ابتدا یه تگ <h2> با متن 'خلاصه:' و بعد یه تگ <p> برای متن خلاصه. این خلاصه نباید تو عنوان اصلی (<h1>) یا هر جای دیگه تکرار بشه.\n"
