...
def translate_title_with_gemini(text_title, target_lang="fa"):
    ...
    prompt = (
        ...
        f"ساختار HTML موجود (مثل تگ‌های <p>, <div>, <b>, <blockquote>, <a>, <h1>, <h2>, <h3>, <h4>, <h5>, <h6>, <ul>, <ol>, <li>) رو دقیقاً حفظ کن و تغییر نده. این شامل خود تگ‌ها، ویژگی‌ها (attributes) و ترتیبشون می‌شه.\n"
...
def translate_with_gemini(text, target_lang="fa"):
    ...
    f"7.در انتها کاربران رو تحریک به نظرسنجی کن.\n"
       ...
       # --- تغییر قانون ۸ ---
    f"8. ساختار HTML موجود (مثل تگ‌های <p>, <div>, <b>, <blockquote>, <a>, <h1>, <h2>, <h3>, <h4>, <h5>, <h6>, <ul>, <ol>, <li>) رو دقیقاً حفظ کن و تغییر نده. این شامل خود تگ‌ها، ویژگی‌ها (attributes) و ترتیبشون می‌شه.\n"
    # --- پایان تغییر قانون ۸ ---
