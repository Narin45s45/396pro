...
f"    5.به جای عنوان و زیر عنوان ها از عنوان های جذاب و کلیدی استفاده کن.\n"
f"    1.در ابتدای متن 2 خط خلاصه از کل متن داشته باش بدون هیچ زیر عنوانی.\n"
f"    3.تحلیل عمیق و ارزش افزوده به متن اضفه کن.\n"
f"    2.در انتهای متن نتیجه گیری کن با زیر عنوان 'نتیجه گیری :'.\n"
f"    4.در انتها کاربران رو تحریک به نظرسنجی کن.\n"
