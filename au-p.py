...
def translate_with_gemini(text, target_lang="fa"):
    ...
    f"4.در اولین خط  بعد از عنوان دو خط خلاصه مفید و کلیدی از کل متن بزار و اولش بنویس 'خلاصه:' و تاکید میکنم که هیچ زیر عنوان یا عنوانی اضافه نکن و تاکید میکنم قبل از پاراگراف خلاصه فقط باید عنوان باشد نه چیز دیگر.\n"
