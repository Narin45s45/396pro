...
def translate_with_gemini(text, target_lang="fa"):
    ...
    f"4.در ابتدای پست دو خط خلاصه مفید و کلیدی از کل متن (نه عنوان) بزار و اولش بنویس 'خلاصه:'و عنوان مقاله یعنی اولین جمله بولد شده و با فونت بزرگتر که تو نباید کاری بهش داشته باشی و بعد از اون میشه متن و فقط متن مقاله رو تو دو خط خلاصه کن و بزار اول متن مقاله یعنی بعد از عنوان یعنی همان جمله بولد شده و فونت بزرگتر.\n"
